...
import { OPTIONS_REACT, OPTIONS_ALERTS } from './utils'
...
class Alerts extends Component {
  render () {
    const { alerts, errorFecth, dateRange, SelectStauts, modalError, modalErrorMessage, selectAlert } = this.props
    const { changeDate, changeStatus, setReact, actionModalError, changeAlert} = this.actions
    return (
      <Wrapper>
        <ModalError
