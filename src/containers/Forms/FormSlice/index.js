  ...
  render() {
    ...
    <Form labelWidth="120" labelPosition={'top'}>
      <Form.Item>
        ...
        <React.Fragment key={i}>
          <Checkbox.Group
            ...
            onChange={value => changeComputes('ischecked', value.length > 0 ? true : false, i)}
          >
      ...
      <React.Fragment>
        ...
        <React.Fragment key={i}>
          <Form.Item>
            <Checkbox.Group value={network.ischecked === false ? [] : [network.name]} onChange={value => changeNetworks('ischecked', value.length > 0 ? true : false,i)}>
        ...
        <React.Fragment key={i}>
          <Form.Item>
            <Checkbox.Group value={wifi.ischecked === false ? [] : [wifi.name]} onChange={value => changeSDN('ischecked', value.length > 0 ? true : false, i)}>
