...
class FormNetwork extends Component {
  render () {
    ...
    const { name, bandwidth, floatingIps, provisionedTags,
      tagRangeInit, tagRangeEnd, cidr, gwIp, bandwidthUnit } = form
    const { addProvisionedTags, removeProvisionedTags, setValueProvisioned,
      change } = this.actions
    return (
      <Wrapper>
        <Title>Network</Title>
