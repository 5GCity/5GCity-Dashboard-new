  ...
  <svg width={props.width || '3rem'} height={props.height || '3rem'} viewBox='0 0 48 60' {...props}>
    ...
    <g fill='none' fillRule='evenodd'>
      <path
        ...
        fill='#FFF'
      />
      <circle fill={props.fill || '#89979F'} cx={24} cy={24} r={20} />
...
export const NodeBoxLTE = props => (
  <svg width={36} height={44} viewBox="0 0 36 44" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill={props.fill || '#89979F'} xlinkHref="#prefix__a" />
        <path
          d="M18 14.06c.621 0 1.143.203 1.584.619.441.416.666.946.666 1.592 0 .929-.45 1.6-1.35 2.016V26h-1.8v-7.713c-.9-.415-1.35-1.087-1.35-2.016 0-.646.234-1.176.666-1.592.432-.416.963-.62 1.584-.62m4.221-1.945c1.125 1.105 1.728 2.485 1.809 4.157 0 1.592-.603 2.99-1.809 4.175l-1.071-1.08c.9-.804 1.35-1.84 1.35-3.095 0-1.176-.45-2.211-1.35-3.096l1.071-1.061m-9.54-1.08c-1.431 1.407-2.151 3.15-2.151 5.237s.72 3.803 2.151 5.21l-1.053 1.078C9.9 20.764 9 18.66 9 16.271c0-2.388.9-4.476 2.628-6.271l1.053 1.035M24.372 10C26.1 11.795 27 13.883 27 16.27c0 2.477-.9 4.574-2.628 6.29l-1.053-1.08c1.431-1.406 2.151-3.148 2.151-5.21 0-2.06-.72-3.829-2.151-5.235L24.372 10m-10.593 2.114l1.071 1.061c-.9.814-1.35 1.84-1.35 3.096 0 1.176.45 2.211 1.35 3.096l-1.071 1.079c-1.206-1.186-1.809-2.583-1.809-4.175 0-1.592.603-2.972 1.809-4.157z"
          fill="#FFF"
          fillRule="nonzero"
          mask="url(#prefix__b)"
        />
